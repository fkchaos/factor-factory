"""12 日指数移动均线因子（ema_12d）。

对应灵感池 i20260820-015（P1）：取截至 t 的 12 日 EMA(close)。
迅投口径 IC=0.845 / IR=0.310。
PIT 安全：ewm(span=12, adjust=False) 对每个 asset 历史独立向后看；close 为已发生价格。
"""
