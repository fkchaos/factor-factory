...
对应灵感池 i20260820-026（P1）：取截至 t 的 5 日 EMA(close)。
迅投口径 IC=0.604 / IR=0.116。
PIT 安全：ewm(span=5, adjust=False) 对每个 asset 历史独立向后看；close 为已发生价格。
"""
