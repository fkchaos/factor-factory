...
def render_html(rows, generated, hs_n, unreleased=0):
    ...
    deliv_html = (
        ...
        '<div class="l">因子明细 <code>deliverables/factors/&lt;fcode&gt;/card.md</code> · '
        '信号明细 <code>deliverables/signals/&lt;scode&gt;/card.md</code></div>'
        '<div class="l">策略导出 <code>deliverables/strategy_export/*.json</code>（机器可读真源）· '
        '跨因子矩阵 <code>deliverables/universe_matrix/</code> · '
        '完整查阅地图见 <a href="https://github.com/fkchaos/factor-factory/blob/main/docs/DELIVERABLES.md">docs/DELIVERABLES.md</a></div>'
        '</div>'
    )
