...
|---|---|---|---|---|
| hs300 | 0.0115 | 0.102 | 53.2% | 494 |
| hs800 | 0.0118 | 0.106 | 54.1% | 569 |
...
- 复现命令：FF_PROVIDER=baostock python scripts/real_research.py --factor delta_roe --pool hs300

## 聚合视图（本因子在聚合交付中的位置）
- 机器可读发货形态：`../strategy_export/stock_factors.json`（条目 name=f0079a，供策略组阶段 0 消费）
