...
|---|---|---|---|---|
| hs300 | -0.0020 | -0.031 | 49.0% | 1576 |
| hs800 | -0.0038 | -0.073 | 47.8% | 1576 |
...
- 复现命令：FF_PROVIDER=baostock python scripts/real_research.py --factor min3_return --pool hs300

## 聚合视图（本因子在聚合交付中的位置）
- 机器可读发货形态：`../strategy_export/stock_factors.json`（条目 name=f0040a，供策略组阶段 0 消费）
