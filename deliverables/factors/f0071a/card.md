...
|---|---|---|---|---|
| hs300 | -0.0010 | -0.011 | 49.5% | 1569 |
| hs800 | 0.0029 | 0.035 | 52.1% | 1573 |
...
- 复现命令：FF_PROVIDER=baostock python scripts/real_research.py --factor revenue_yoy --pool hs300

## 聚合视图（本因子在聚合交付中的位置）
- 机器可读发货形态：`../strategy_export/stock_factors.json`（条目 name=f0071a，供策略组阶段 0 消费）
