...
|---|---|---|---|---|
| hs300 | 0.0159 | 0.219 | 58.4% | 1595 |
| hs800 | 0.0164 | 0.246 | 58.1% | 1595 |
...
- 复现命令：FF_PROVIDER=baostock python scripts/real_research.py --factor size_log_mcap --pool hs300
- 已知陷阱：特定牛熊阶段 / 流动性枯竭。

## 聚合视图（本因子在聚合交付中的位置）
- 机器可读发货形态：`../strategy_export/stock_factors.json`（条目 name=f0010a，供策略组阶段 0 消费）
