...
- 逻辑一句话：前瞻 EP：分子（年化预告净利）阶梯、分母（市值）逐日。
...
|---|---|---|---|---|
| hs300 | 0.0039 | 0.035 | 52.0% | 1538 |
| hs800 | 0.0070 | 0.070 | 52.7% | 1551 |
...
- 复现命令：FF_PROVIDER=baostock python scripts/real_research.py --factor forecast_ep --pool hs300

## 聚合视图（本因子在聚合交付中的位置）
- 机器可读发货形态：`../strategy_export/stock_factors.json`（条目 name=f0075a，供策略组阶段 0 消费）
