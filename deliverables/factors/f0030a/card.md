...
|---|---|---|---|---|
| hs300 | -0.0073 | -0.104 | 44.6% | 1576 |
| hs800 | -0.0113 | -0.197 | 40.4% | 1576 |
...
- 复现命令：FF_PROVIDER=baostock python scripts/real_research.py --factor volume_cv_20d --pool hs300

## 聚合视图（本因子在聚合交付中的位置）
- 机器可读发货形态：`../strategy_export/stock_factors.json`（条目 name=f0030a，供策略组阶段 0 消费）
