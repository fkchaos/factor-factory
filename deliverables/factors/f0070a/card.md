...
|---|---|---|---|---|
| hs300 | 0.0083 | 0.073 | 51.8% | 1570 |
| hs800 | 0.0139 | 0.124 | 53.6% | 1578 |
...
- 复现命令：FF_PROVIDER=baostock python scripts/real_research.py --factor ep --pool hs300

## 聚合视图（本因子在聚合交付中的位置）
- 机器可读发货形态：`../strategy_export/stock_factors.json`（条目 name=f0070a，供策略组阶段 0 消费）
