...
|---|---|---|---|---|
| hs300 | 0.0173 | 0.139 | 55.9% | 1123 |
| hs800 | 0.0135 | 0.103 | 53.7% | 1521 |
...
- 复现命令：FF_PROVIDER=baostock python scripts/real_research.py --factor limit_up_seal --pool hs300
- 已知陷阱：特定牛熊阶段 / 流动性枯竭。

## 聚合视图（本因子在聚合交付中的位置）
- 机器可读发货形态：`../strategy_export/stock_factors.json`（条目 name=f0009a，供策略组阶段 0 消费）
