...
|---|---|---|---|---|
| hs300 | 0.0049 | 0.070 | 52.0% | 1569 |
| hs800 | 0.0018 | 0.035 | 50.9% | 1575 |
...
- 复现命令：FF_PROVIDER=baostock python scripts/real_research.py --factor cash_coverage --pool hs300

## 聚合视图（本因子在聚合交付中的位置）
- 机器可读发货形态：`../strategy_export/stock_factors.json`（条目 name=f0067a，供策略组阶段 0 消费）
