...
|---|---|---|---|---|
| hs300 | -0.0062 | -0.081 | 46.8% | 1569 |
| hs800 | -0.0026 | -0.054 | 46.7% | 1575 |
...
- 复现命令：FF_PROVIDER=baostock python scripts/real_research.py --factor accrual --pool hs300

## 聚合视图（本因子在聚合交付中的位置）
- 机器可读发货形态：`../strategy_export/stock_factors.json`（条目 name=f0068a，供策略组阶段 0 消费）
