...
|---|---|---|---|---|
| hs300 | -0.0024 | -0.036 | 49.1% | 1576 |
| hs800 | -0.0044 | -0.083 | 47.6% | 1577 |
...
- 复现命令：FF_PROVIDER=baostock python scripts/real_research.py --factor max5_return --pool hs300

## 聚合视图（本因子在聚合交付中的位置）
- 机器可读发货形态：`../strategy_export/stock_factors.json`（条目 name=f0039a，供策略组阶段 0 消费）
