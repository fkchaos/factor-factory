...
|---|---|---|---|---|
| hs300 | 0.0105 | 0.096 | 54.0% | 1589 |
| hs800 | 0.0132 | 0.122 | 54.8% | 1589 |
...
- 复现命令：FF_PROVIDER=baostock python scripts/real_research.py --factor reversal_5 --pool hs300
- 已知陷阱：特定牛熊阶段 / 流动性枯竭。

## 聚合视图（本因子在聚合交付中的位置）
- 机器可读发货形态：`../strategy_export/stock_factors.json`（条目 name=f0007a，供策略组阶段 0 消费）
