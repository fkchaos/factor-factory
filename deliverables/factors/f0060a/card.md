...
|---|---|---|---|---|
| hs300 | 0.0039 | 0.043 | 51.4% | 1569 |
| hs800 | 0.0044 | 0.050 | 51.9% | 1575 |
...
- 复现命令：FF_PROVIDER=baostock python scripts/real_research.py --factor roe --pool hs300

## 聚合视图（本因子在聚合交付中的位置）
- 机器可读发货形态：`../strategy_export/stock_factors.json`（条目 name=f0060a，供策略组阶段 0 消费）
