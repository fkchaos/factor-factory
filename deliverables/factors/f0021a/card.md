...
- 复现命令：FF_PROVIDER=baostock python scripts/real_research.py --factor ema_120d --pool hs300

## 聚合视图（本因子在聚合交付中的位置）
- 机器可读发货形态：`../strategy_export/stock_factors.json`（条目 name=f0021a，供策略组阶段 0 消费）
