...
|---|---|---|---|---|
| hs300 | 0.0004 | 0.004 | 49.4% | 1538 |
| hs800 | 0.0028 | 0.038 | 51.9% | 1551 |
...
- 复现命令：FF_PROVIDER=baostock python scripts/real_research.py --factor forecast_yoy --pool hs300

## 聚合视图（本因子在聚合交付中的位置）
- 机器可读发货形态：`../strategy_export/stock_factors.json`（条目 name=f0073a，供策略组阶段 0 消费）
