...
|---|---|---|---|---|
| hs300 | -0.0141 | -0.187 | 42.0% | 1595 |
| hs800 | -0.0147 | -0.226 | 40.1% | 1595 |
...
- 复现命令：FF_PROVIDER=baostock python scripts/real_research.py --factor lower_shadow --pool hs300

## 聚合视图（本因子在聚合交付中的位置）
- 机器可读发货形态：`../strategy_export/stock_factors.json`（条目 name=f0028a，供策略组阶段 0 消费）
