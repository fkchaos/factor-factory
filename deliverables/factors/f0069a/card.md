...
|---|---|---|---|---|
| hs300 | -0.0009 | -0.013 | 49.6% | 1569 |
| hs800 | -0.0029 | -0.052 | 48.3% | 1575 |
...
- 复现命令：FF_PROVIDER=baostock python scripts/real_research.py --factor deduct_ratio --pool hs300

## 聚合视图（本因子在聚合交付中的位置）
- 机器可读发货形态：`../strategy_export/stock_factors.json`（条目 name=f0069a，供策略组阶段 0 消费）
