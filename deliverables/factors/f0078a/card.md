...
|---|---|---|---|---|
| hs300 | 0.0074 | 0.065 | 52.0% | 1570 |
| hs800 | 0.0118 | 0.101 | 53.5% | 1578 |
...
- 复现命令：FF_PROVIDER=baostock python scripts/real_research.py --factor value_bm --pool hs300

## 聚合视图（本因子在聚合交付中的位置）
- 机器可读发货形态：`../strategy_export/stock_factors.json`（条目 name=f0078a，供策略组阶段 0 消费）
