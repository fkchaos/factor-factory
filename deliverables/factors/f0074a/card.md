...
|---|---|---|---|---|
| hs300 | 0.0027 | 0.032 | 52.1% | 1538 |
| hs800 | 0.0028 | 0.037 | 52.7% | 1551 |
...
- 复现命令：FF_PROVIDER=baostock python scripts/real_research.py --factor forecast_kind --pool hs300

## 聚合视图（本因子在聚合交付中的位置）
- 机器可读发货形态：`../strategy_export/stock_factors.json`（条目 name=f0074a，供策略组阶段 0 消费）
